...
//      util_itoa(days_hold,date_days,10);
//      util_itoa(months_hold,date_months,10);
//      util_itoa(years_hold,date_years,10);
      _itoa(days_hold,date_days,10);
      _itoa(months_hold,date_months,10);
      _itoa(years_hold,date_years,10);

/*
      _gcvt(double(days_hold),2,date_days);
      _gcvt(double(months_hold),2,date_months);
      _gcvt(double(years_hold),4,date_years);
*/
      if (days_hold < 10)
      {
...

{
	*holiday_result = findhol_no_hol;
	...
	_itoa(in_date.date.years,_years,10);
	_itoa(in_date.date.months,_months,10);
	_itoa(in_date.date.days,_days,10);
	string _date(_years);
