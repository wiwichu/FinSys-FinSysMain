...
//	util__gcvt( (LocalRateInstr.rate * 100), rate_precision, RC_Rate1 );
	_gcvt( (LocalRateInstr.rate * 100), rate_precision, RC_Rate1 );
...
//		util__gcvt( BootResultArray[element_count].factor, factor_precision, BootFactor);
		_gcvt( BootResultArray[element_count].factor, factor_precision, BootFactor);
